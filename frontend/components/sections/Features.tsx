  ...
  return (
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full">
        ...
        <div className="absolute top-40 right-10 w-72 h-72 bg-purple-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse" />
        <div className="absolute bottom-20 left-1/2 w-72 h-72 bg-pink-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse" />
      </div>
      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <Marquee pauseOnHover className="[--duration:20s]">
            {[
              "Celo Foundation", "Chainlink", "Polygon", "Ethereum Foundation", 
              "ConsenSys", "Coinbase", "Binance", "OpenSea", "Uniswap", "Aave"
            ].map((company, index) => (
              <div key={index} className="mx-8 text-gray-400 font-medium">
                {company}
              </div>
            ))}
          </Marquee>
